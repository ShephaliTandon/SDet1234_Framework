...
public class CreatePOwithItemandclickonDownwardSymbolTest extends BaseClass{
	...
	public void CreatePOwithItemandclickonDownwardSymbol() throws Throwable
	{
		...
		/* step 4 add detail of purchaseorder in create purchase order */
