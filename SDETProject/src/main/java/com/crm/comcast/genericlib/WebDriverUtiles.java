...
public class WebDriverUtiles {
   ...
   public void swictToFrame(WebDriver driver , String id, String name) {
	...
	public String takeScreenshot(WebDriver driver, String methodname) throws IOException
	{
		...
		String screenshotpath = System.getProperty("user.dir")+"/Screenshot/"+methodname+JavaUtils.getDateAndTime();
		File dest = new File("./Screenshot/"+methodname+JavaUtils.getDateAndTime()+".png");
		Files.copy(src,dest);
